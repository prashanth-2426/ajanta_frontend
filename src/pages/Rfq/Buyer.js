...
export default function Buyer({
  ...
  useEffect(() => {
    if (existingAuction) {
      ...
      if (existingAuction?.messages?.length) {
        setMessages(existingAuction.messages);
      }
    }
  }, [existingAuction]);
  ...
  useEffect(() => {
    ...
    setTableRows(rows);
    setWinner(rows.find((row) => row.rank === 1 || row.rank === "L1"));
  }, [bids, users, ranks, existingAuction]);
            ...
            <div className="grid align-items-center">
              ...
              <div className="col-12 lg:col-8">
                ...
                <div className="flex gap-2 flex-wrap mt-3">
                  ...
                  <Tag value={`AUCTION END TIME :`} severity="success" />:{" "}
                ...
                {countdownLabel && !isAuctionEnded && (
                  ...
                  >
                    ...
                    >
                      ...
                      Extend auction duration in real-time for all participants
                    </div>
                  </div>
                )}
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          Congratulations to the winning vendor
                        </div>
                      </div>
                    </div>
                    ...
                    <div style={{ color: "#fff", lineHeight: "1.8" }}>
                      <div>
                        <strong>Vendor:</strong> {winner.vendorName}
                      </div>

                      <div>
                        <strong>Company:</strong> {winner.company}
                      </div>

                      <div>
                        <strong>Airline:</strong> {winner.airlineName}
                      </div>

                      <div>
                        <strong>Rank:</strong> L{winner.rank}
                      </div>

                      <div>
                        <strong>Final Bid:</strong> ₹
                        {Number(winner.bid).toLocaleString("en-IN")}
                      </div>
                    </div>
                  </div>
                )} */}
